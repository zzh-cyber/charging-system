...
| 66 |  | 对应NO.4 附近查询-条数切换 | 按距离排序结果供客户端截取 5/10 条 | 【对应用户端NO.4】【消息】复用 type=station_list。【客户端发】切换 5/10 条时再次发送相同 lat/lng。【服务端收】同 NO.65。【库操作】同 NO.65，返回按 distance 排好的列表。【服务端回】按距离排序的 list，distance≥0。【客户端展示】校验 station id 唯一后截取 5 或 10 条；服务端未给 distance 时客户端用 Haversine 兜底。 | 翟梓涵 | 2026-09-04 | △ |  |
